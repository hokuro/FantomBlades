...
public class GuiBladeforge extends ContainerScreen<ContainerBladeforge> {
	...
	public GuiBladeforge(ContainerBladeforge container, PlayerInventory playerInv, ITextComponent titleIn){
	...
	protected void drawGuiContainerForegroundLayer(int i, int j){
		font.drawString(net.minecraft.client.resources.I18n.format("gui.bladeforge.title"),8,4,4210752);
	...
	protected void drawGuiContainerBackgroundLayer(float f, int x, int y){
        ...
        this.blit(i+46, j+17, 176, 0, 8, getIronBar());
        this.blit(i+121, j+17, 176, 0, 8, getCoalBar());

        if (entity.getField(TileEntityBladeforge.FIELD_STATE) == BlockBladeforge.STAGE_2){
            this.blit(i+55, j+16, 184, 0, 66, 59);
        }
	}
