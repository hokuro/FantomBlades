...
public class GuiArmorSmith extends ContainerScreen<ContainerArmorSmith> {
	private static final ResourceLocation tex = new ResourceLocation("fbd", "textures/gui/armorsmith.png");
	private InventoryArmorSmith smithInv;
	private Button button_create;
	private Button button_repair;

	public GuiArmorSmith(ContainerArmorSmith container, PlayerInventory playerInv, ITextComponent title) {
		super(container, playerInv, title);
		smithInv = (InventoryArmorSmith)container.getSmithInventory();
		this.ySize = 192;
	}
	...
	protected void drawGuiContainerForegroundLayer(int i, int j){
		font.drawString("gui.armorsmith",8,4,4210752);
