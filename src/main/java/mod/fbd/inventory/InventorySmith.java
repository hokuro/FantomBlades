...
public class InventorySmith implements IInventory {
    ...
    {
        return new TextComponentTranslation("inventory.bladesmith");
    }
...
//	}
	...
	public int getBladePiece(EnumBladePieceType types) {
		int ret = 0;
		for (ItemStack stack : stacks){
			if (stack.getItem() instanceof ItemBladePiece && ((ItemBladePiece)stack.getItem()).getPieceType() == types){
				ret += stack.getCount();
			}
		}
		return ret;
