...
public class IntaractionObjectBladeSmith implements IInteractionObject {

	public int entityId;

	public IntaractionObjectBladeSmith(int id) {
		entityId = id;
	}
	...
	public Container createContainer(InventoryPlayer playerInventory, EntityPlayer playerIn) {
		...
		if (entity instanceof EntityArmorSmith){
			return new ContainerBladeSmith(playerIn.inventory, ((EntityArmorSmith)entity).getSmithInventory(), playerIn.world);
		}
		return null;
	}
	...
	public String getGuiID() {
		// TODO 自動生成されたメソッド・スタブ
		return ModCommon.MOD_ID + ":" + ModCommon.GUI_ID_BLADESMITH;
	}
