...
public class IntaractionObjectRevolver implements IInteractionObject {
	private EnumHand have;

	public IntaractionObjectRevolver(EnumHand hand) {
		have = hand;
	}
	...
	public String getGuiID() {
		// TODO 自動生成されたメソッド・スタブ
		return ModCommon.MOD_ID + ":" + ModCommon.GUI_ID_REVOLVER;
	}
