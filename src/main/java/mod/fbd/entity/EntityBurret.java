	...
	public static final int REGISTERID = 2;
	    ...
	    protected void onHit(RayTraceResult raytraceResultIn)
	    {
	        ...
	        else
	        {
	            ...
	            this.inGround = true;
	            this.arrowShake = 7;
                ((ItemBurret)burret.getItem()).getBurret().hitBlock(world, burret, this.shootingEntity,this);
	            if (iblockstate.getMaterial() != Material.AIR)
	            {
	    ...
	    public void writeEntityToNBT(NBTTagCompound compound)
	    {
	        ...
	        compound.setTag("burret", burret.writeToNBT(new NBTTagCompound()));
	    }
	    ...
	    public void readEntityFromNBT(NBTTagCompound compound)
	    {
	        ...
	        this.burret = new ItemStack((NBTTagCompound) compound.getCompoundTag("burret"));
	    }
	    ...
	    {
			compound.setInteger("burretType", burretType.getIndex());
	    	 return compound;
	    }
	    ...
	    {
			burretType =  EnumBurret.getFromIndex(compound.getInteger("burretType"));
	    }
}
